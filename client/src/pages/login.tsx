        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="firstName" className="text-barbershop-text">{t("login.firstName.label")}</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="lastName" className="text-barbershop-text">{t("login.lastName.label")}</Label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-barbershop-muted h-4 w-4" />
                <Input
                  id="lastName"
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-barbershop-text">{t("login.password.label")}</Label>
              <div className="relative">
          ...
          <div className="mt-6 barbershop-dark rounded-lg p-4">
            ...
            <div className="text-xs text-barbershop-muted space-y-2">
              ...
              <div className="border-l-2 border-green-500 pl-3">
                <p className="font-medium text-barbershop-text">{t("login.demo.credentials.guest.title")}</p>
                <p>{t("login.demo.credentials.guest.description")}</p>
              </div>
            </div>
          </div>
